...
@dvhb/icons/1.2.0 linux-x64 node-v12.14.1
...
_See code: [src/commands/figma2svg.ts](https://github.com/dvhb/icons/blob/v1.2.0/src/commands/figma2svg.ts)_
...
_See code: [src/commands/generate.ts](https://github.com/dvhb/icons/blob/v1.2.0/src/commands/generate.ts)_
